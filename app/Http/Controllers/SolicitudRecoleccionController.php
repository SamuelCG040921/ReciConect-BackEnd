...
class SolicitudRecoleccionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $SolicitudRecoleccion = SolicitudRecoleccion::create($request->all());
        return response()->json($SolicitudRecoleccion, 201);
    }

    /**
     * Display the specified resource.
     */
    public function show(SolicitudRecoleccion $solicitudRecoleccion)
    {
        //
    }
